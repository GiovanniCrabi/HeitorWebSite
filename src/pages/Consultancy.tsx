import { ButtonConsultancy } from "../components/ButtonConsultancy";
...
export const Consultancy = () => {
  return (
    <div className="">
      ...
      <div 
        className="space-x-0 md:space-x-20 space-y-8 md:space-y-0 py-8 md:py-72 flex flex-col md:flex-row justify-center items-center bg-gradient-to-r from-black.5 to-black "
      >
      <ButtonConsultancy 
